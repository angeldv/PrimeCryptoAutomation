// src/main.js
/**
 * Main entry point for PrimeCryptoAutomation application
 */
...
class PrimeCryptoAutomation {
    /**
     * Create a new PrimeCryptoAutomation instance
...
module.exports = PrimeCryptoAutomation;
...
if (require.main === module) {
    ...
    const app = new PrimeCryptoAutomation({
        input: args.input,
        output: args.output,
