// test/test_primeCryptoAutomation.js
/**
 * Unit tests for PrimeCryptoAutomation
 */

const assert = require('assert');
const { PrimeCryptoAutomation } = require('../src/main');
const fs = require('fs').promises;
const path = require('path');

describe('PrimeCryptoAutomation', function() {
    this.timeout(5000);
